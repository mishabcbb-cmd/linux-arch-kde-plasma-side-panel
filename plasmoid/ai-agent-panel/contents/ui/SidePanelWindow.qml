...
Window {
    ...
    // Properties are set via LayerShell.Window.<property> on the Window itself.
    ...
    LayerShell.Window.scope: "ai-agent-panel"
    LayerShell.Window.exclusionZone: 0  // Don't reserve space in panel
    LayerShell.Window.margins: { left: 0; top: 0; bottom: 0; right: 0 }
