...
class ContextManager:
    ...
    DEFAULT_SYSTEM_PROMPT = (
        ...
        "- For file operations: use file_read to read, file_write to create/modify.\n"
        "- For terminal commands: use bash_exec.\n"
        "- For code search: use search_codebase.\n"
        "- For repo overview: use repo_map.\n"
        "- Call tools immediately — do not ask for permission.\n"
        "- When the task is done, call no more tools and state TASK_COMPLETE.\n\n"
        "## Instructions\n"
